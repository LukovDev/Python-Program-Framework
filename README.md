...
Скачать репозиторий можно [zip-файлом](https://github.com/LukovDev/Python-Program-Framework/archive/refs/heads/master.zip), или склонировать репозиторий с помощью Git ```https://github.com/LukovDev/Python-Program-Framework.git```
