...
Перейдите в [релизы](https://github.com/LukovDev/Python-Program-Framework/releases) и выберите последний релиз. Там будут архивы (варианты этого фреймворка) под вашу систему.

На данный момент, официально фреймворк работает на: **Windows**, **MacOS**.

Не забывайте что фреймворки на данный момент не совместимы между собой операционными системами. Система сборки на **Windows** и **MacOS** пока что работает немного по разному, и не факт что они будут работать одинаково одновременно на двух системах!
